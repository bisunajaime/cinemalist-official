...
final _initialActorRankingState = <String, List<RankingModel>>{
  's': [],
  'a': [],
  'b': [],
  'c': [],
...
class ActorRankingCubit extends Cubit<Map<String, List<RankingModel>>> {
  late final LocalStorageRepository localStorageRepository;
  bool isLoading = true;
  ActorRankingCubit() : super(_initialActorRankingState) {
  ...
  String get fileName => 'actor_rankings.json';
  ...
  Future<void> initialLoad() async {
    ...
    await localStorageRepository.save(jsonEncode(_initialActorRankingState));
    setIsLoading(false);
  }
  ...
  Future<void> updateMovieIndex(
    ...
    rankingData.insert(newIndex == -1 ? 0 : newIndex, movedMovie);
