  ...
  Widget build(BuildContext context) {
    ...
    if (cubit.state.length == rankingCubit.rankedRecordsCount) {
      return DragTarget<RankingModel>(
        onAccept: (data) async {
          final letter =
              MovieRankingHelper.findLetterOfModel(rankingCubit.state, data);
          if (letter == null) return;
          await rankingCubit.removeMovie(letter, data);
        },
        ...
        return Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final alreadyRanked = MovieRankingHelper.alreadyRanked(
                movie.id!,
                rankingCubit.state,
              );
